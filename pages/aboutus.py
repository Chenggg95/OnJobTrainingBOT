...
st.write(f"""We are Air Force Engineer from the Republic of Singapore Air Force.  Our primary job is to maintain and ensure that the aircraft is fit for flying to protect Singapore from adversary threats. 
